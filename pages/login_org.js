...
const Signin = () => {
  ...
  const handleSubmit = async e => {
    ...
    const res = await postData('auth/login_org', orgData)
    console.log(res)
  ...
  return(
    <div>
      ...
      <form className="mx-auto my-4" style={{maxWidth: '500px'}} onSubmit={handleSubmit}>
        ...
        <p className="my-2">
          You don't have an account? <Link href="/register_org"><a style={{color: 'crimson'}}>Register Now</a></Link>
        </p>
      </form>
    </div>
  )
